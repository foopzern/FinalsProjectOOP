...
public class MatchSuggestionPanelController implements Initializable {
    ...
    @FXML private void goToDashboard()       { navigateTo("/com/example/findit/views/AdminDashboardSidebar.fxml", "Dashboard"); }
    @FXML private void goToReportedItems()   { navigateTo("/com/example/findit/views/ReportedItems.fxml", "Reported Items"); }
    @FXML private void goToClaims()          { navigateTo("/com/example/findit/views/Claims.fxml", "Claims"); }
    @FXML private void goToMatchSuggestions(){ /* already here */ }
    @FXML private void handleLogout()        { navigateTo("/com/example/findit/views/AdminLogin.fxml", "Admin Login"); }
